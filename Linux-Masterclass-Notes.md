...
12. [grep and Pipelines](#grep-and-pipeline-commands)
13. [SSH](#ssh---secure-shell)
14. [SCP](#scp---secure-copy)
15. [chmod](#chmod---change-file-permissions)
16. [Cron](#cron-jobs---scheduling-tasks)
17. [Disk Management, ZIP and TAR](#disk-management-zip-and-tar)
18. [Word Count, Sort and Unique Values](#word-count-sort-and-unique-values)
19. [find](#20-find-command)
20. [awk](#21-awk-command)
21. [Package Management](#22-package-management)
22. [Apache Airflow](#23-apache-airflow)
23. [Basic Networking Commands](#24-basic-networking-commands)
