...
Beginner-friendly notes and practical examples from the Linux Masterclass.
...
4. [More File and Directory Commands](#4-more-file-and-directory-commands)
...
8. [Command History and Autocomplete](#8-command-history-and-autocomplete)
9. [Alias and nohup](#9-alias-and-nohup)
10. [Hard Links and Symbolic Links](#10-hard-links-and-symbolic-links)
11. [Background Jobs and Process Management](#11-background-jobs-and-process-management)
12. [grep and Pipelines](#12-grep-and-pipelines)
13. [SSH](#13-ssh)
14. [SCP](#14-scp)
15. [chmod](#15-chmod)
16. [Cron](#16-cron)
17. [Disk Management, ZIP and TAR](#17-disk-management-zip-and-tar)
18. [wc, sort and uniq](#18-wc-sort-and-uniq)
19. [find](#19-find)
20. [awk](#20-awk)
21. [Package Management](#21-package-management)
22. [Airflow Basics](#22-airflow-basics)
23. [Basic Networking Commands](#23-basic-networking-commands)
24. [Bash Shell Scripting](#24-bash-shell-scripting)
